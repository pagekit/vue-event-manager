...
### CDN
Available on [jsdelivr](https://cdn.jsdelivr.net/npm/vue-event-manager@1.0.1) or [unpkg](https://unpkg.com/vue-event-manager@1.0.1).
```html
<script src="https://cdn.jsdelivr.net/npm/vue-event-manager@1.0.1"></script>
```
